class Tabs {
	constructor(element) {
		...
		this.itemElement = document.querySelector(`.tabs-link[data-tab='${this.element.dataset.tab}']`);
		this.tabLink = new TabLink(this.itemElement);
...
class TabLink {
	...
	deselect() {
		const element = document.querySelector(`.tabs-link-selected`);
